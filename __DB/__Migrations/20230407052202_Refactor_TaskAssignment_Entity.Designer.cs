...
namespace TaskManagement.DB.Migrations
{
    ...
    [Migration("20230407052202_Refactor_TaskAssignment_Entity")]
    partial class RefactorTaskAssignmentEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskManagement.Entities.TaskAssignment", b =>
                {
                    ...
                    b.Property<Guid?>("AssignedEmployeeId")
                        ...
                        .HasComputedColumnSql("CASE WHEN [assignee_type] = 'Employee' THEN [assigned_to] ELSE NULL END", true);

                    b.Property<Guid?>("AssignedTeamId")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("assigned_team_id")
                        .HasComputedColumnSql("CASE WHEN [assignee_type] = 'Team' THEN [assigned_to] ELSE NULL END", true);
                    ...
                    b.HasIndex("TaskId", "AssignedBy", "AssignedTo", "AssigneeType")
                        .IsUnique()
                        .HasDatabaseName("task_assignment_unique_index");

                    b.HasIndex(new[] { "AssignedBy" }, "tasks_assignments_assigned_by_fk_index");

                    b.HasIndex(new[] { "AssignedEmployeeId" }, "tasks_assignments_assigned_to_employee_fk_index");

                    b.HasIndex(new[] { "AssignedTo" }, "tasks_assignments_assigned_to_index");

                    b.HasIndex(new[] { "AssignedTeamId" }, "tasks_assignments_assigned_to_team_fk_index");
