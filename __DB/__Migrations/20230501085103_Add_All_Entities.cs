        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by = table.Column<Guid>(name: "created_by", type: "uniqueidentifier", nullable: false),
                    manage_by = table.Column<Guid>(name: "manage_by", type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    takenby = table.Column<Guid>(name: "taken_by", type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    task_id = table.Column<Guid>(name: "task_id", type: "uniqueidentifier", nullable: false),
                    assignedby = table.Column<Guid>(name: "assigned_by", type: "uniqueidentifier", nullable: false),
                    assignedto = table.Column<Guid>(name: "assigned_to", type: "uniqueidentifier", nullable: false),
                    assigneetype = table.Column<string>(name: "assignee_type", type: "varchar(30)", maxLength: 30, nullable: false),
                    assignedat = table.Column<DateTime>(name: "assigned_at", type: "datetime2(3)", nullable: false, defaultValueSql: "SYSDATETIME()"),
                    leftat = table.Column<DateTime>(name: "left_at", type: "datetime2(3)", nullable: true),
                    leavereason = table.Column<string>(name: "leave_reason", type: "nvarchar(500)", maxLength: 500, nullable: true),
                    assignedemployee_id = table.Column<Guid>(name: "assigned_employee_id", type: "uniqueidentifier", nullable: true, computedColumnSql: "CASE WHEN [assignee_type] = 'Employee' THEN [assigned_to] ELSE NULL END", stored: true),
                    assignedteam_id = table.Column<Guid>(name: "assigned_team_id", type: "uniqueidentifier", nullable: true, computedColumnSql: "CASE WHEN [assignee_type] = 'Team' THEN [assigned_to] ELSE NULL END", stored: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.assignedemployee_id,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
