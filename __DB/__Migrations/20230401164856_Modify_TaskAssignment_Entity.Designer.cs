...
namespace TaskManagement.DB.Migrations
{
    ...
    [Migration("20230401164856_Modify_TaskAssignment_Entity")]
    partial class ModifyTaskAssignmentEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskManagement.Entities.TaskAssignment", b =>
                {
                    ...
                    b.HasOne("TaskManagement.Entities.Employee", null)
                    ...
                    b.HasOne("TaskManagement.Entities.Team", null)
                        .WithMany("AssignedTasks")
