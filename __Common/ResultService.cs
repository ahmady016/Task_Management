...
public interface IResultService
{
    ...
    IResult Succeeded(string sender, string message);
    IResult Succeeded(dynamic data);
}
...
public class ResultService : IResultService
{
    ...
    public IResult Succeeded(string sender, string message)
    {
        _message = $"{sender} => {message}";
        return Results.Ok(new { Message = message });
    }
    public IResult Succeeded(dynamic data)
    {
